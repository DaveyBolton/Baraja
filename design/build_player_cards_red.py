...
# 1979140122), ruby-red instead of gold. Generated clean at effectively
# zero margin already (no crop/scale step needed, unlike rainbow). Only
# ART_TOP/TITLE_CENTER_Y reuse gold's layout - the cost-gem and medallion
# sockets are measured directly on THIS frame file, since each generation
# places its ring/gem a bit differently even at identical scale (assuming
# gold's exact pixel position here first put the medallion ~15px above
# where this frame's ring actually is).
# Do not regenerate or otherwise alter this file.
FRAME_PATH = r"C:\Dev\Stephen-AI-Studio\ArtEngine\out\baraja_card_frame_v17_red\card_frame_v17_red_zero_margin.png"
...
OUT_DIR = r"C:\Dev\Baraja\design\cards_red"
OUT_DIR_EN = r"C:\Dev\Baraja\design\cards_red_en"
...
TITLE_LINE_GAP = 4
TITLE_STROKE = 2
TITLE_FILL = (240, 215, 180, 255)  # warm ivory, reads well against black and this frame's red
TITLE_STROKE_FILL = (50, 10, 10, 255)
...
COST_CX, COST_CY, COST_R = 93, 78, 56
COST_FONT_SIZE = 80

MEDALLION_CX, MEDALLION_CY, SOCKET_R = 368, 957, 50
...
def build_card(card, frame_alpha, lang="es"):
    ...
    d.ellipse([COST_CX - COST_R, COST_CY - COST_R, COST_CX + COST_R, COST_CY + COST_R],
              fill=(235, 220, 200, 255), outline=(150, 30, 30, 255), width=4)
