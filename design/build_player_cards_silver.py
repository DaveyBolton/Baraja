...
# 1979140122), bright/shiny silver instead of gold - lighter and glossier
# than the existing enemy-deck silver (v14), per Dave. Generated clean at
# effectively zero margin already (no crop/scale step needed, unlike
# rainbow). ART_TOP/TITLE_CENTER_Y reuse gold's layout, but the cost-gem
# and medallion sockets do NOT reuse gold's exact pixel position - each
# frame generation places its ring/gem at a slightly different spot even
# at identical scale, and assuming otherwise here first put the medallion
# ~17px above where this frame's ring actually is. COST_CX,CY and
# MEDALLION_CY below are measured directly on THIS frame file.
# Do not regenerate or otherwise alter this file.
FRAME_PATH = r"C:\Dev\Stephen-AI-Studio\ArtEngine\out\baraja_card_frame_v16_bright_silver\card_frame_v16_bright_silver_zero_margin.png"
...
OUT_DIR = r"C:\Dev\Baraja\design\cards_silver"
OUT_DIR_EN = r"C:\Dev\Baraja\design\cards_silver_en"
...
TITLE_LINE_GAP = 4
TITLE_STROKE = 2
TITLE_FILL = (225, 225, 235, 255)  # bright silver-white, matches this frame's tone
...
COST_CX, COST_CY, COST_R = 90, 79, 56
COST_FONT_SIZE = 80

MEDALLION_CX, MEDALLION_CY, SOCKET_R = 368, 955, 50
