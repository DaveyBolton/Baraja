...
# 1979140122), royal-purple instead of gold. Generated clean at effectively zero margin
...
FRAME_PATH = r"C:\Dev\Stephen-AI-Studio\ArtEngine\out\baraja_card_frame_v21_purple\card_frame_v21_purple_zero_margin.png"
...
OUT_DIR = r"C:\Dev\Baraja\design\cards_purple"
OUT_DIR_EN = r"C:\Dev\Baraja\design\cards_purple_en"
...
TITLE_LINE_GAP = 4
TITLE_STROKE = 2
TITLE_FILL = (235, 220, 245, 255)  # pale lavender, reads well against black and this frame's purple
TITLE_STROKE_FILL = (30, 10, 45, 255)
...
COST_CX, COST_CY, COST_R = 100, 67, 56
COST_FONT_SIZE = 80

MEDALLION_CX, MEDALLION_CY, SOCKET_R = 368, 954, 50
...
def build_card(card, frame_alpha, lang="es"):
    ...
    d.ellipse([COST_CX - COST_R, COST_CY - COST_R, COST_CX + COST_R, COST_CY + COST_R],
              fill=(235, 225, 245, 255), outline=(110, 40, 150, 255), width=4)
