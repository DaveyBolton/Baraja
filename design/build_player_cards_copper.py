...
# 1979140122), polished copper instead of gold. Generated clean at effectively zero margin
...
FRAME_PATH = r"C:\Dev\Stephen-AI-Studio\ArtEngine\out\baraja_card_frame_v22_copper\card_frame_v22_copper_zero_margin.png"
...
OUT_DIR = r"C:\Dev\Baraja\design\cards_copper"
OUT_DIR_EN = r"C:\Dev\Baraja\design\cards_copper_en"
...
TITLE_LINE_GAP = 4
TITLE_STROKE = 2
TITLE_FILL = (250, 225, 195, 255)  # warm cream, reads well against black and this frame's copper
TITLE_STROKE_FILL = (45, 20, 5, 255)
...
COST_CX, COST_CY, COST_R = 90, 72, 56
COST_FONT_SIZE = 80

MEDALLION_CX, MEDALLION_CY, SOCKET_R = 368, 960, 50
...
def build_card(card, frame_alpha, lang="es"):
    ...
    d.ellipse([COST_CX - COST_R, COST_CY - COST_R, COST_CX + COST_R, COST_CY + COST_R],
              fill=(245, 230, 210, 255), outline=(160, 90, 40, 255), width=4)
