...
# 1979140122), marigold-orange instead of gold. Generated clean at effectively zero margin
...
FRAME_PATH = r"C:\Dev\Stephen-AI-Studio\ArtEngine\out\baraja_card_frame_v23_orange\card_frame_v23_orange_zero_margin.png"
...
OUT_DIR = r"C:\Dev\Baraja\design\cards_orange"
OUT_DIR_EN = r"C:\Dev\Baraja\design\cards_orange_en"
...
TITLE_LINE_GAP = 4
TITLE_STROKE = 2
TITLE_FILL = (255, 235, 210, 255)  # warm ivory, reads well against black and this frame's orange
TITLE_STROKE_FILL = (55, 20, 0, 255)
...
COST_CX, COST_CY, COST_R = 93, 68, 56
COST_FONT_SIZE = 80

MEDALLION_CX, MEDALLION_CY, SOCKET_R = 368, 958, 50
...
def build_card(card, frame_alpha, lang="es"):
    ...
    d.ellipse([COST_CX - COST_R, COST_CY - COST_R, COST_CX + COST_R, COST_CY + COST_R],
              fill=(250, 230, 205, 255), outline=(200, 100, 10, 255), width=4)
