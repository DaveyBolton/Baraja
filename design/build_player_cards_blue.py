...
# 1979140122), sapphire-blue instead of gold. Generated clean at effectively zero margin
...
FRAME_PATH = r"C:\Dev\Stephen-AI-Studio\ArtEngine\out\baraja_card_frame_v19_blue\card_frame_v19_blue_zero_margin.png"
...
OUT_DIR = r"C:\Dev\Baraja\design\cards_blue"
OUT_DIR_EN = r"C:\Dev\Baraja\design\cards_blue_en"
...
TITLE_LINE_GAP = 4
TITLE_STROKE = 2
TITLE_FILL = (225, 235, 250, 255)  # ice-white, reads well against black and this frame's blue
TITLE_STROKE_FILL = (10, 20, 45, 255)
...
COST_CX, COST_CY, COST_R = 108, 68, 56
COST_FONT_SIZE = 80
...
def build_card(card, frame_alpha, lang="es"):
    ...
    d.ellipse([COST_CX - COST_R, COST_CY - COST_R, COST_CX + COST_R, COST_CY + COST_R],
              fill=(225, 235, 245, 255), outline=(30, 70, 150, 255), width=4)
